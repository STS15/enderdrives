...
public final class ClientConfigCache {
    ...
    private static volatile int driveBitmask = DEFAULT_MASK;

    public static volatile int freqMin = 0;
    public static volatile int freqMax = 4095;
